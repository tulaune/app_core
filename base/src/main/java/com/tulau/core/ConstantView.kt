...
object ConstantView {
    ...
    const val LAYOUT_WIDTH_OFFSET = 20f

    const val DEFAULT_TAG_TEXT_SIZE = 14f
    const val DEFAULT_TAG_DELETE_INDICATOR_SIZE = 14f
    const val DEFAULT_TAG_ADD_INDICATOR_SIZE = 14f
    const val DEFAULT_TAG_LAYOUT_BORDER_SIZE = 0f
    const val DEFAULT_TAG_RADIUS = 100f
    val DEFAULT_TAG_LAYOUT_COLOR = parseColor("#00BFFF")
    val DEFAULT_TAG_LAYOUT_COLOR_PRESS = parseColor("#88363636")
    val DEFAULT_TAG_TEXT_COLOR = parseColor("#ffffff")
    val DEFAULT_TAG_DELETE_INDICATOR_COLOR = parseColor("#ffffff")
    val DEFAULT_TAG_LAYOUT_BORDER_COLOR = parseColor("#ffffff")
    val DEFAULT_TAG_ADD_INDICATOR_COLOR = parseColor("#ffffff")
    const val DEFAULT_TAG_DELETE_ICON = "✖"
    const val DEFAULT_TAG_IS_DELETABLE = false
    const val DEFAULT_TAG_IS_ADDTABLE = false
    const val DEFAULT_TAG_ADD_ICON = "✚"
